# Aevia Health — kandidater til bestyrelse / talsperson

**Formål:** Reelle, offentligt kendte danske profiler inden for aldring og forebyggende sundhed, som du kan kontakte og spørge, om de vil indgå i Aevias bestyrelse, advisory board eller som faglig talsperson.

> **Vigtigt:** Sæt INGEN navne på hjemmesiden, før personen har sagt ja skriftligt. Indtil da er det kun en henvendelse — ikke en aftale.

---

## Sådan positionerer du henvendelsen (læs først)

Flere af de tungeste navne har offentligt været kritiske over for kommercielle "longevity-klinikker" og kosttilskuds-hype. Det er ikke en hindring — det er en mulighed. Får du en af dem med, signalerer det, at Aevia er **seriøs og evidensbaseret**. Men din henvendelse skal ramme præcis det:

- Læg vægt på: akkrediteret diagnostik, lægefaglig tolkning, ingen kosttilskud, ingen urealistiske løfter.
- Undgå ord som "anti-aging", "vend din alder", "biohacking".
- Vær ydmyg, kort og konkret. Bed om et uforpligtende møde, ikke et ja på forhånd.

---

## Kandidater

### 1. Nicklas Brendborg — mest realistiske (talsperson / rådgiver)
- **Hvem:** Molekylærbiolog (ph.d.) og bestseller-forfatter om aldring ("Gåder i en celle", udgivet internationalt som "Jellyfish Age Backwards").
- **Hvorfor:** Ung, formidlingsstærk, vant til medier og offentlig optræden. God som faglig talsperson/ambassadør og mere tilgængelig end de etablerede professorer.
- **Kontaktvej:** Via forlag (People'sPress / Gyldendal-koncernen) eller direkte på LinkedIn. Søg "Nicklas Brendborg" på LinkedIn.
- **Realisme:** Middel-høj.

### 2. Morten Scheibye-Knudsen — størst faglig tyngde (advisory board)
- **Hvem:** Læge og en af Danmarks førende aldringsforskere, Center for Sund Aldring, Københavns Universitet. Forfatter til "Udødelig".
- **Hvorfor:** Giver enorm videnskabelig troværdighed. Ideel til et fagligt advisory board.
- **Kontaktvej:** KU's medarbejderprofil (søg navnet på sund.ku.dk → e-mail står offentligt på profilen).
- **Realisme:** Lav-middel (forsker, travl, kritisk over for kommerciel hype — men netop derfor værdifuld).

### 3. Bente Klarlund Pedersen — størst offentlig gennemslagskraft
- **Hvem:** Professor i klinisk medicin, KU, leder af Center for Aktiv Sundhed. En af landets mest kendte sundhedsstemmer (klummeskribent, forfatter).
- **Hvorfor:** Maksimal autoritet og kendskab i offentligheden.
- **Kontaktvej:** KU's medarbejderprofil (e-mail offentlig).
- **Realisme:** Lav (meget eftertragtet og travl). Et langskud, men værd at prøve.
...
3. Få et uforpligtende møde, før du taler titel/rolle.
4. Når nogen siger ja: aftal præcis rolle (bestyrelse vs. advisory vs. talsperson), honorar/equity, og skriftligt samtykke til at bruge navn + billede på sitet.

---

## Mail-udkast (dansk) — tilpas [skarpe parenteser]

**Emne:** Fagligt advisory board til Aevia Health — en kort forespørgsel

Kære [Navn]

Jeg hedder Lucas Mejer Hansen og står bag Aevia Health, en ny dansk virksomhed, der koordinerer evidensbaseret, forebyggende helbredsdiagnostik for private og virksomheder. Vi laver ikke kosttilskud og lover ikke et længere liv. Vi samler akkrediteret diagnostik (blodpaneler, VO2max, billeddiagnostik) i ét forløb og kobler det til en lægefaglig tolkning, så folk kan handle på reelle tal i tide.

Jeg følger dit arbejde, og netop fordi du er kritisk og fagligt skarp, er du den type stemme, jeg gerne vil have tæt på Aevia. Jeg overvejer at samle et lille fagligt advisory board, der kan holde os ærlige og evidensbaserede.

Vil du være åben for en uforpligtende kop kaffe eller et kort videomøde, hvor jeg fortæller mere? Det forpligter dig ikke til noget.

På forhånd tak for din tid.

Venlig hilsen
Lucas Mejer Hansen
Grundlægger, Aevia Health
kontakt@aevia.dk · +45 28 30 39 33 · aevia.dk

---

## Mail-udkast (engelsk) — hvis relevant

**Subject:** A short request — medical advisory board for Aevia Health

Dear [Name],

My name is Lucas Mejer Hansen, founder of Aevia Health, a new Danish company that coordinates evidence-based preventive health diagnostics for individuals and companies. We don't sell supplements and we don't promise a longer life. We bring accredited diagnostics (blood panels, VO2max, imaging) together in one pathway with a proper medical interpretation, so people can act on real numbers in time.

I follow your work, and precisely because you are rigorous and evidence-focused, you are the kind of voice I'd like close to Aevia. I'm considering forming a small medical advisory board to keep us honest and evidence-based.

Would you be open to an informal coffee or a short video call so I can tell you more? There's no obligation.

Thank you for your time.

Best regards,
Lucas Mejer Hansen
Founder, Aevia Health
kontakt@aevia.dk · +45 28 30 39 33 · aevia.dk
